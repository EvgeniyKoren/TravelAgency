...
public class SelectTourCommand extends Command {

    private static final long serialVersionUID = 773228621402947850L;

    private static final Logger LOG = Logger.getLogger(SelectTourCommand.class);
